package claycorp.wyldmod.utils;
...
public final class Properties { // Block Id's
    ...
    public static int convayornzID;
    public static int convayornxID;
    public static int convayoryID;
    public static int convayorzyID;
    public static int convayorxyID;
    ...
    public static int shroomxp;
    public static int shroomdamage;
    public static int shroomfollowrange;
    public static int shroomknockbackresistance;
    public static int shroomplayerkillitemdrop;
    public static int shroomquantityofdropplayerkill;
